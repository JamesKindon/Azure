        ...
        foreach ($Snapshot in $SourceSnapshots) {
            try {
                ...
                try {
                    ...
                    $SnapSasUrl = Grant-AzSnapShotAccess -ResourceGroupName $SourceResourceGroup -SnapshotName $Snapshot.Name -DurationInSecond 28800 -Access Read -ErrorAction Stop
